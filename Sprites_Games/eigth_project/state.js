...
export class SittingLeft extends State{
    ...
    handleInput(input){
        if(input === 'PRESS right') this.player.setState(states.SITTING_RIGHT); //set state to sitting left
...
export class SittingRight extends State{
    ...
    handleInput(input){
        if(input === 'PRESS left') this.player.setState(states.SITTING_LEFT); //set state to sitting right
...
export class RunningLeft extends State{
    ...
    handleInput(input){
        if(input === 'PRESS right') this.player.setState(states.RUNNING_RIGHT); //set state to sitting right
...
export class RunningRight extends State{
    ...
    handleInput(input){
        if(input === 'PRESS left') this.player.setState(states.RUNNING_LEFT); //set state to sitting right
