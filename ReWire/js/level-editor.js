const createLevelEditorSystem = (space, inputControl) => {
    const mouseWheelListener = (e) => {
        e.preventDefault();
        const spool = (inputControl.targets[0][0]).spool || (inputControl.targets[0][0]).block;
    ...
    const keydownListener = (e) => {
        ...
        if (e.key === 'F2') {
            const level = { spools: [], isolators: [], blocks: [] };
